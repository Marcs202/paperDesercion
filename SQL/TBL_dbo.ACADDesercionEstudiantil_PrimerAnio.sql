...
IF OBJECT_ID(N'dbo.ACADDesercionEstudiantil_PrimerAnio', N'U') IS NOT NULL
    DROP TABLE dbo.ACADDesercionEstudiantil_PrimerAnio;
GO

CREATE TABLE dbo.ACADDesercionEstudiantil_PrimerAnio (
...
INSERT INTO dbo.ACADDesercionEstudiantil_PrimerAnio
SELECT 
...
SELECT COUNT(*) AS TotalEstudiantes FROM dbo.ACADDesercionEstudiantil_PrimerAnio;
...
FROM dbo.ACADDesercionEstudiantil_PrimerAnio
GROUP BY Deserto
...
select * from ga..ACADDesercionEstudiantil_PrimerAnio
